...
<form method="POST" action="{{route('admin.store')}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="name" type="text" class="form-control" name="name" required autofocus placeholder="Nombre Apellido">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="email" type="email" class="form-control" name="email" required placeholder="ejemplo@gmail.com">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <select class="form-control" id="role" name="role">
                ...
                <option value="{{$role['id']}}">{{$role['roles_nombre']}}</option>
                @endforeach
            </select>
        </div>
    </div>
