...
class VerificationController extends Controller
{
    ...
    public function verify(Request $request)
    {
        ...
        return view('emails.verify', compact('usuario', 'permisos'))->with('success', 'Email verificado exitosamente!');
    ...
    public function setPassword(Request $request, $id)
    {
        ...
        $user->save();
        return view('home.index', compact('permisos'))->with('success', 'Contraseña establecida correctamente.');
    }
